    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            <div class="sidebar-menu">
                ...
                <form class="form" id="form" action="profile_script.php" enctype="multipart/form-data" method="post">
        ...
        <div class="box-container">
            <div class="chart-container">
                <div class="chart-box">
                    ...
                    <p>faculty registered</p>

                </div>
                <?php
                $query_teacher = mysqli_query($conn, "select * from student") or die(mysqli_error());
                $count_teacher = mysqli_num_rows($query_teacher);
                ?>
                <div class="chart-box">
                    <div class="chart" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"
                ...
                <?php
                $query_teacher = mysqli_query($conn, "select * from session") or die(mysqli_error());
                $count_teacher = mysqli_num_rows($query_teacher);
                ?>
                <div class="chart-box">
                    <div class="chart" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"
