...
<body>
  ...
  <div class="wrapper">
    ...
    ?>
      ...
      <li class="item">
        <a href="studentfrontpage.php?user_id=<?php echo $user['id']; ?>&department=<?php echo $dep; ?>&semester=<?php echo $sem; ?>" class="menu-btn">
...
$count=0;
        while($row = mysqli_fetch_assoc($result))
        {
         ...
         echo"
                    ...
                    <div class='card'>
                    <div class='image'>
                    <a href='student_unitcard.php?user_id=" . $user['id'] . "&department=$dep&subject_id=$subjectId&semester=$sem'>
                    <img
                        src='$subimg'>
                    </div>";
