...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="add_unit_mba.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subjectId; ?>&department=<?php echo $dep; ?>&semester=<?php echo $semester; ?>"
                    class="menu-btn">
            ...
            ?>
            <li class="item">
                <a href="admin_subjectsmba.php?user_id=<?php echo $user['id']; ?>&department=MBA&semester=<?php echo $semester; ?>"
                    class="menu-btn">
        ...
        <div class="box-container">
            ...
            for ($index = 0; $index <= 2; $index++) {
              ...
              <div class='title'>
                ...
                echo "<a href='admin_session_mba.php?user_id=" . $user['id'] . "&subject_id=$subjectId&unit=$unitIndex&session=1&semester=$semester'>
                <button>session 1</button></a>";
                echo "<a href='admin_session_mba.php?user_id=" . $user['id'] . "&subject_id=$subjectId&unit=$unitIndex&session=2&semester=$semester'>
