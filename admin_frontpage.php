...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <li class="item" id="profile">
                ...
                <div class="sub-menu">
                    <a href="admin_sempage.php?user_id=<?php echo $user['id']; ?>&department=MCA"><span>MCA</span></a>
                    <a href="admin_semmba.php?user_id=<?php echo $user['id']; ?>&department=MBA"></i><span>MBA</span></a>
            ...
            <li class="item">
                <a href="announcement.php?user_id=<?php echo $user['id']; ?>" class="menu-btn">
    ...
    <div class="container">
        ...
        <div class="box-container">
            ...
            <div class="card">
                <a href="admin_sempage.php?user_id=<?php echo $user['id']; ?>&department=MCA">
            ...
            <div class="card">
                <a href="admin_semmba.php?user_id=<?php echo $user['id']; ?>&department=MBA">
