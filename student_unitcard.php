...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="student_subject_page.php?user_id=<?php echo $user['id']; ?>&department=<?php echo $dep;?>&semester=<?php echo $semester;?>"
                    class="menu-btn">
        ...
        <div class="box-container">
            ...
            for ($index = 0; $index <= 2; $index++) {
              ...
              <div class='title'>
                ...
                echo "<a href='student_session.php?department=$dep&user_id=" . $user['id'] . "&subject_id=$subjectId&unit=$unitIndex&session=1&semester=$semester'>
                <button>session 1</button></a>";
                echo "<a href='student_session.php?department=$dep&user_id=" . $user['id'] . "&subject_id=$subjectId&unit=$unitIndex&session=2&semester=$semester'>
