...
<body>
        ...
        <div class="box-container">
            <div class="testbox">
                <form id="createform" method="post">
                    ...
                    <div class="item">
                        <p>Enter semester</p>
                        <input type="text" name="sem" id="sem" placeholder="semester" required>
                    </div>
                    <div class="item">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO faculty (name,registernumber,email,department,phonenumber,year,status,sem) 
VALUES ('$name','$rrn','$email','$department','$phonenumber','$year','unregistered','$sem')";
