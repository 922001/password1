...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <li class="item">
        <a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=<?php echo $dep; ?>&semester=<?php echo $sem; ?>"
          class="menu-btn">
    ...
    function createData() {
      $('#createform').click(
        function (e) {
          ...
          $.ajax({
            type: "POST",
            url: '/lmscres/updateSubject.php?user_id=<?php echo $_GET['user_id']; ?>',
            data: $(this).serialize(),
