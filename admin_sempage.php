    ...
    <div class="box-container">
      <div class="card">
        ...
        <div class="title">
          ...
          $dep = $_GET['department']
            ?>
          <button><a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=1"
      ...
      <div class="card">
        ...
        <div class="title">
          ...
          $dep = $_GET['department']
            ?>
          <button><a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=2"
              class="btn">read more</a></button>
        </div>
      </div>
      <!-- card ends -->
      ...
      <div class="card">
        ...
        <div class="title">
          ...
          $dep = $_GET['department']
            ?>
          <button><a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=3"
              class="btn">read more</a></button>
        </div>
      </div>
      <!-- card ends -->
      ...
      <div class="card">
        ...
        <div class="title">
          ...
          $dep = $_GET['department']
            ?>
          <button><a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=4"
              class="btn">read more</a></button>
        </div>
      </div>
      <!-- card ends -->
